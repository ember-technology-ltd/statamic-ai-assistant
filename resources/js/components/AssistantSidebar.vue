<template>
    <div class="fixed top-1/2 right-0">
        <div class="bg-white rounded-l-full border-l border-t border-b border-grey-50">
            <button type="button" class="flex items-center pl-2 pr-1 py-2 focus:outline-none" @click="showForm = !showForm">
                <svg fill="#000000" class="w-5 h-5" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="bg-white h-screen overflow-auto relative p-4">
                ...
                <template v-if="!tool">
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-4">
                        <div class="border border-grey-40 rounded-lg p-4">
